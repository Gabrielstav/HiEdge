...
class BiasMerger:
    ...
    def __init__(self, config: Config, interaction_df: dd.DataFrame, bias_file_path: Path, bed_length=None):
        self.config = config
    ...
    def _read_and_process_bias(self) -> dd.Series:
    ...
    @staticmethod
    def _merge_bias_with_interaction(interaction_ddf, bias_df, bed_length) -> dd.DataFrame:
